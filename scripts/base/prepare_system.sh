...
ColorPalette=#000000;#ff0000;#00ff00;#ffff00;#0000ff;#ff00ff;#00ffff;#00ff00;#555555;#ff5555;#55ff55;#ffff55;#5555ff;#ff55ff;#55ffff;#ffffff
...
# Configure theme
if [[ -f /opt/croc/scripts/base/configure_theme.sh ]]; then
  bash /opt/croc/scripts/base/configure_theme.sh
fi
